        ...
        <div class="p-4 sm:p-6 xl:p-9">
            ...
            <div class="flex justify-end p-6">
                <div class="max-w-65 w-full">
                    ...
                    <asp:Button runat="server" ID="btn_download" Text="Download" OnClick="btnCalculate_Click"
                        CssClass="bg-red-600 p-4 px-7.5 float-right mt-10 inline-flex items-center gap-2.5 rounded py-2.5 font-medium text-white hover:bg-opacity-90"></asp:Button>
