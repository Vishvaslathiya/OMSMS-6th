<%@ Page Title="" Language="C#" MasterPageFile="~/Res/Customer_Navbar.Master" AutoEventWireup="true" CodeBehind="Cust_Order_Bill.aspx.cs"   %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="border-stroke shadow-default dark:border-strokedark dark:bg-boxdark mb-10 rounded-sm border bg-white">
  <div class="border-stroke dark:border-strokedark border-b px-4 py-4 sm:px-6 xl:px-9">
  ...
  <div class="p-4 sm:p-6 xl:p-9">
    <div class="mb-10 flex flex-wrap items-center justify-end gap-3.5">
      <div class="">
        <h1 class="text-[30px]">730294039</h1>
      </div>
      <button class="bg-meta-3 inline-flex items-center gap-2.5 rounded bg-red-600 px-4 py-[7px] font-medium text-white hover:bg-opacity-90">
      ...
      <button class="bg-primary inline-flex items-center gap-2.5 rounded bg-green-600 px-4 py-[7px] font-medium text-white hover:bg-opacity-90">
        <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex flex-wrap justify-between gap-5">
      <div>
        ...
        <a href="#" class="block"><span class="font-medium text-black dark:text-white">Email:</span> contact@example.com</a>
        <span class="mt-1.5 block"><span class="font-medium text-black dark:text-white">Address:</span> 2972 Westheimer Rd. Santa Ana.</span>
      </div>
      ...
      <div>
        ...
        <a href="#" class="block"><span class="font-medium text-black dark:text-white">Email:</span> contact@example.com</a>
        <span class="mt-1.5 block"><span class="font-medium text-black dark:text-white">Address:</span> New York, USA 2707 Davis Anenue</span>
      </div>
    </div>

    <div class="my-7.5 border-stroke dark:border-strokedark xsm:grid-cols-2 grid grid-cols-1 border sm:grid-cols-4">
      <div class="border-stroke dark:border-strokedark border-b border-r px-5 py-4 last:border-r-0 sm:border-b-0">
        <h5 class="mb-1.5 font-bold text-black dark:text-white">Invoice ID :</h5>
        <span class="text-sm font-medium"> #STK83084398239 </span>
      </div>

      <div class="border-stroke dark:border-strokedark border-b px-5 py-4 last:border-r-0 sm:border-b-0 sm:border-r">
        <h5 class="mb-1.5 font-bold text-black dark:text-white">Date Issued :</h5>
        <span class="text-sm font-medium"> 29, Nov 2027 </span>
      </div>

      <div class="border-stroke dark:border-strokedark xsm:border-b-0 border-b border-r px-5 py-4 last:border-r-0">
    ...
    <div class="border-stroke dark:border-strokedark border">
      <div class="max-w-full overflow-x-auto">
        <div class="min-w-[670px]">
          <!-- table header start -->
          <div class="border-stroke dark:border-strokedark grid grid-cols-12 border-b py-3.5 pl-5 pr-6">
      ...
      <div class="flex justify-end p-6">
        <div class="max-w-65 w-full">
          ...
          <p class="border-stroke dark:border-strokedark mt-4 flex justify-between border-t pt-5">
            ...
            <span class="text-meta-3 font-bold"> $4475 </span>
          </p>

          <button class="bg-primary px-7.5 float-right mt-10 inline-flex items-center gap-2.5 rounded py-2.5 font-medium text-white hover:bg-opacity-90">
            Download
            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
