<%@ Page Title="" Language="C#" MasterPageFile="~/Res/Customer_Navbar.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="OMSMS6.Customer.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="flex flex-col items-center w-full my-20">
      <span class="mb-8">
        <svg width="140" viewBox="0 0 419 95" fill="none" xmlns="">
           <defs>
      ...
      <div class="flex items-center">
        <p class="text-base font-normal leading-7 text-center text-grey-700">
          2024 OMSMS. All rights reserved.</p>
      </div>
    </div>
  </div>
</div>
